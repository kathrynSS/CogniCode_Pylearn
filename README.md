...
- **Interactive Knowledge Graph:** Visualize and navigate Python concepts dynamically with D3.js.
- **AI Chatbot Tutor:** Multi-turn, contextual conversations with personalized learning support and code review.
- **Project-Based Learning:** AI-powered task breakdown, step-by-step guides, and progress tracking.
- **Online Python IDE:** Write, run, and debug Python code in the browser, with line-by-line AI explanations.
- **Resource & Note Management:** Upload/download materials, personal notes, and Google Drive sync.
- **Secure User System:** JWT-based authentication, personal workspace, and full privacy controls.

---

## 🏗️ Tech Stack

- **Backend:** Flask, Neon PostgreSQL, OpenAI SDK, Google Drive API, JWT
- **Frontend:** D3.js v7, Vanilla JS, CSS Grid/Flexbox, Font Awesome
